...
from podcastquotes.views import PodcastDeleteView, PodcastUpdateView, PodcastDetailView, PodcastListView
from podcastquotes.views import EpisodeDeleteView, EpisodeUpdateView, EpisodeDetailView, EpisodeListView
