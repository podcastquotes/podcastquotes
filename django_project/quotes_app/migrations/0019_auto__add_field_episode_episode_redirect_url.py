...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.episode_redirect_url'
        db.add_column(u'quotes_app_episode', 'episode_redirect_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.episode_redirect_url'
        db.delete_column(u'quotes_app_episode', 'episode_redirect_url')
    ...
    models = {
        ...
        u'quotes_app.episode': {
            ...
            'episode_redirect_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
