...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'quotes_app_podcast', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):
        # Adding field 'Podcast.image_small'
        db.add_column(u'quotes_app_podcast', 'image_small',
                      self.gf('stdimage.fields.StdImageField')(default=3, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.image_all'
        db.add_column(u'quotes_app_podcast', 'image_all',
                      self.gf('stdimage.fields.StdImageField')(default=2, max_length=100, blank=True),
                      keep_default=False)
