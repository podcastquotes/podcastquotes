...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'quotes_app_episode', 'guid', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Adding field 'Podcast.tumblr_url'
        db.add_column(u'quotes_app_podcast', 'tumblr_url',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Episode.guid'
        db.alter_column(u'quotes_app_episode', 'guid', self.gf('django.db.models.fields.URLField')(max_length=200))
        # Deleting field 'Podcast.tumblr_url'
        db.delete_column(u'quotes_app_podcast', 'tumblr_url')
