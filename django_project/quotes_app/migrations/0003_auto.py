...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field moderators on 'Podcast'
        m2m_table_name = db.shorten_name(u'quotes_app_podcast_moderators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('podcast', models.ForeignKey(orm[u'quotes_app.podcast'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['podcast_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field moderators on 'Podcast'
        db.delete_table(db.shorten_name(u'quotes_app_podcast_moderators'))
