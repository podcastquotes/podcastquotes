...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.image_small'
        db.add_column(u'quotes_app_podcast', 'image_small',
                      self.gf('django_resized.forms.ResizedImageField')(default=datetime.datetime(2014, 7, 15, 0, 0), max_length=100, max_width=250, max_height=250, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.image_tiny'
        db.add_column(u'quotes_app_podcast', 'image_tiny',
                      self.gf('django_resized.forms.ResizedImageField')(default=datetime.datetime(2014, 7, 15, 0, 0), max_length=100, max_width=100, max_height=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.image_small'
        db.delete_column(u'quotes_app_podcast', 'image_small')
    ...
    models = {
        ...
        u'quotes_app.podcast': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
            'image_small': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'max_width': '250', 'max_height': '250', 'blank': 'True'}),
            'image_tiny': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'max_width': '100', 'max_height': '100', 'blank': 'True'}),
