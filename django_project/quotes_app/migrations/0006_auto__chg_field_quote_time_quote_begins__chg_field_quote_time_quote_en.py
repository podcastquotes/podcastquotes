...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quote.time_quote_begins'
        db.alter_column(u'quotes_app_quote', 'time_quote_begins', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Quote.time_quote_ends'
        db.alter_column(u'quotes_app_quote', 'time_quote_ends', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Quote.time_quote_begins'
        db.alter_column(u'quotes_app_quote', 'time_quote_begins', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Quote.time_quote_ends'
        db.alter_column(u'quotes_app_quote', 'time_quote_ends', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'quotes_app.quote': {
            ...
            'time_quote_begins': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
