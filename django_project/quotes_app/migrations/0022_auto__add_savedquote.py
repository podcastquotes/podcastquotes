...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SavedQuote'
        db.create_table(u'quotes_app_savedquote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('saver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('quote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quotes_app.Quote'])),
        ))
        db.send_create_signal(u'quotes_app', ['SavedQuote'])


    def backwards(self, orm):
        # Deleting model 'SavedQuote'
        db.delete_table(u'quotes_app_savedquote')
    ...
    models = {
        ...
        u'quotes_app.savedquote': {
            'Meta': {'object_name': 'SavedQuote'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quote': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quotes_app.Quote']"}),
            'saver': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
