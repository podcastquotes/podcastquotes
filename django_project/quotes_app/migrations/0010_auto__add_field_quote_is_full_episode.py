...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.is_full_episode'
        db.add_column(u'quotes_app_quote', 'is_full_episode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.is_full_episode'
        db.delete_column(u'quotes_app_quote', 'is_full_episode')
