...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.image'
        db.alter_column(u'quotes_app_episode', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_width=250, max_height=250))

        # Changing field 'Podcast.image'
        db.alter_column(u'quotes_app_podcast', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_width=250, max_height=250))

        # Changing field 'UserProfile.image'
        db.alter_column(u'quotes_app_userprofile', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_width=250, max_height=250))

    def backwards(self, orm):

        # Changing field 'Episode.image'
        db.alter_column(u'quotes_app_episode', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Podcast.image'
        db.alter_column(u'quotes_app_podcast', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_height=200, max_width=200))

        # Changing field 'UserProfile.image'
        db.alter_column(u'quotes_app_userprofile', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'quotes_app.episode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'max_width': '250', 'max_height': '250', 'blank': 'True'}),
