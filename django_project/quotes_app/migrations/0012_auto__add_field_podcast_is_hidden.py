...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.is_hidden'
        db.add_column(u'quotes_app_podcast', 'is_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.is_hidden'
        db.delete_column(u'quotes_app_podcast', 'is_hidden')
