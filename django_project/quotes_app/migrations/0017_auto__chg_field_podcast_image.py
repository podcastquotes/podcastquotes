...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'quotes_app_podcast', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_width=200, max_height=200))
    ...
    models = {
        ...
        u'quotes_app.podcast': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'max_width': '200', 'max_height': '200', 'blank': 'True'}),
