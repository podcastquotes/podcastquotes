...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.managed_by_superuser'
        db.add_column(u'quotes_app_podcast', 'managed_by_superuser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.managed_by_superuser'
        db.delete_column(u'quotes_app_podcast', 'managed_by_superuser')
