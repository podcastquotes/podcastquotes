...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.alphabetical_title'
        db.add_column(u'quotes_app_podcast', 'alphabetical_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.alphabetical_title'
        db.delete_column(u'quotes_app_podcast', 'alphabetical_title')
